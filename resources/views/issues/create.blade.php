@php
    $types = \TomatoPHP\TomatoCategory\Models\Type::where('for', 'issues')->where('type', 'types')->get();
    $statues = \TomatoPHP\TomatoCategory\Models\Type::where('for', 'issues')->where('type', 'status')->get();
